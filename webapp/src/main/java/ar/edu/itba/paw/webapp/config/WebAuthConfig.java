    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
            ...
            .authorizeRequests()
                ...
                .antMatchers("/borrar-negocio/{businessId}").access("@BusinessServiceImpl.isBusinessOwner(#businessId,@userServiceImpl.findByUsername(authentication.name).get().userId)")
