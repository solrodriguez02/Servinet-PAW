    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
            ...
            .authorizeRequests()
                ...
                .antMatchers("/negocio/{businessID}/**","/borrar-negocio/{businessID}","/crear-servicio/{businessID}").access("@BusinessServiceImpl.isBusinessOwner(#businessID,@securityServiceImpl.currentUser.get().userId)")
                .antMatchers("/rechazar-turno/{appointmentId}","/turno/{serviceId}/{appointmentId}","/aceptar-turno/{appointmentId}","/cancelar-turno/{appointmentId}").access("@securityServiceImpl.isUserAppointment(#appointmentId)")
                .antMatchers("/negocios/**","/publicar","/crear-servicio").hasRole("BUSINESS")
